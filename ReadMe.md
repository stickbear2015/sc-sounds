...
Small note! If you're updating to a newer soundpack, and you've already installed a version that has the settings.set and StarConquestBufferlist.txt files, you don't need to copy the ones from this archive. 
...
5. if this is a knew installation, copy "StarConquestBufferlist.txt"  into the route of your VIP Mud folder.
6. If you have any other troubles, find a bug, or have a feature suggestion, please post an issue to [the issue tracker](https://github.com/stickbear2015/sc-sounds/issues/new/choose)